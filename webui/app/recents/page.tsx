...
function formatTimestamp(timestamp: number, showAbsolute: boolean = false): string {
  if (showAbsolute) {
...
function formatDurationBetween(startTimeMs?: number, endTimeMs?: number): string | null {
