...
import { Data } from '@/lib/converter/wow-model/bundle/animation';
...
export type WowAnimName = typeof ANIM_NAMES[number] | 'unknown' | ''

export function getWowAnimName(anim_id: number): WowAnimName {
  if (anim_id in ANIM_NAMES) return ANIM_NAMES[anim_id];
...
export const getWc3AnimName = (wowAnimName: string): Pick<SequenceData, 'wc3Name' | 'attackTag' | 'loop'> => {
  switch (wowAnimName) {
    ...
    case 'AttackUnarmedOff': return { wc3Name: 'Attack ', attackTag: 'Unarmed' };
    case 'SpecialUnarmed': return { wc3Name: 'Attack Slam', attackTag: 'Unarmed' };
    ...
    case 'Attack1HPierce': return { wc3Name: 'Attack', attackTag: '1H' };
    case 'AttackOff': return { wc3Name: 'Attack', attackTag: '1H' };
    case 'AttackOffPierce': return { wc3Name: 'Attack', attackTag: '1H' };
    case 'CombatAbility1HPierce': return { wc3Name: 'Attack', attackTag: '1H' };
    case 'CombatAbility1HOffPierce': return { wc3Name: 'Attack', attackTag: '1H' };
    case 'Special1H': return { wc3Name: 'Attack Slam', attackTag: '1H' };
    case 'CombatAbility1H01': return { wc3Name: 'Attack Slam', attackTag: '1H' };
    case 'CombatAbility1H01Off': return { wc3Name: 'Attack Slam', attackTag: '1H' };
    case 'CombatAbility1H02': return { wc3Name: 'Attack Slam', attackTag: '1H' };
    case 'CombatAbility1H02Off': return { wc3Name: 'Attack Slam', attackTag: '1H' };
    case 'CombatAbility1H03Off': return { wc3Name: 'Attack Slam', attackTag: '1H' };
    case 'CombatAbility1HBig01': return { wc3Name: 'Attack Slam', attackTag: '1H' };
    case 'CombatBladeStorm': return { wc3Name: 'Attack Slam', attackTag: '1H' };
    ...
    case 'CombatAbility2H01': return { wc3Name: 'Attack Slam', attackTag: '2H' };
    case 'CombatAbility2H02': return { wc3Name: 'Attack Slam', attackTag: '2H' };
    case 'CombatAbility2H03': return { wc3Name: 'Attack Slam', attackTag: '2H' };
    case 'CombatAbility2HBig01': return { wc3Name: 'Attack Slam', attackTag: '2H' };
    ...
    case 'CastCurseRight': return { wc3Name: 'Spell', attackTag: '' };
    case 'CastOutStrong': return { wc3Name: 'Spell', attackTag: '' };
    case 'CastStrongLeft': return { wc3Name: 'Spell', attackTag: '' };
    case 'CastStrongRight': return { wc3Name: 'Spell', attackTag: '' };
    case 'CastStrongUpLeft': return { wc3Name: 'Spell', attackTag: '' };
    case 'CastStrongUpRight': return { wc3Name: 'Spell', attackTag: '' };
...
export function getWacraftSequenceData(animation: Data.Animation): SequenceData {
  const wowName = getWowAnimName(animation.id);
  const wc3Name = getWc3AnimName(wowName);
  return {
    ...wc3Name, wowName, wowVariant: animation.variationIndex, wowFrequency: animation.frequency / 32767,
  };
}
