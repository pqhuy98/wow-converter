...
// WoW Attachment ID enum based on https://wowdev.wiki/M2#Attachments
...
export const getWoWAttachmentName = (attachmentId: number) => wowAttachmentEntries.find(([_, value]) => value === attachmentId)?.[0] ?? 'unknown';
