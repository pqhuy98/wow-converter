/**
 * Animation ID to name mapping, ported from wow.export (src/js/3D/AnimMapper.js).
 * Retrieved from https://github.com/Marlamin/wow.tools.local (index-based).
 */
...
export function get_anim_name(anim_id: number): string {
